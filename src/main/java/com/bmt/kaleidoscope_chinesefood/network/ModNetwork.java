...
public class ModNetwork {
   public static void register() {
      PayloadTypeRegistry.playS2C().register(TextEditOpenS2CPayload.TYPE, TextEditOpenS2CPayload.STREAM_CODEC);
      PayloadTypeRegistry.playC2S().register(TextEditUpdateC2SPayload.TYPE, TextEditUpdateC2SPayload.STREAM_CODEC);
