...
public class ModConfig {
    ...
    public static void init() {
        NeoForgeConfigRegistry.INSTANCE.register(KaleidoscopeChineseFood.MODID, net.neoforged.fml.config.ModConfig.Type.COMMON, SPEC);
        NeoForgeModConfigEvents.loading(KaleidoscopeChineseFood.MODID).register(ModConfig::onLoad);
        NeoForgeModConfigEvents.reloading(KaleidoscopeChineseFood.MODID).register(ModConfig::onReload);
    }
