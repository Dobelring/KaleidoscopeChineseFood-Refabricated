 ...
 * <p>
 * 与原版行为对齐（NeoForge loot_modifiers/add_grass_drops）：破坏草丛掉落茄子种子需要
 * 非剪刀工具、头戴厨房乐事草帽（#kaleidoscope_cookery:straw_hat）、15% 概率。
 */
        ...
        LootTableEvents.MODIFY.register((key, tableBuilder, source, registries) -> {
            if (source.isBuiltin()) {
                ...
                if (SHORT_GRASS.equals(loc) || TALL_GRASS.equals(loc)) {
                    // 26.x 的 ItemPredicate.Builder.of 需要 HolderGetter<Item>，从回调的 registries 获取
