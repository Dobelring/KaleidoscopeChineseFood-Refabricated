...
public class ModFoods {
   ...
   public static final Consumable DRY_POT_POTATOES_C = Consumables.defaultFood()
      .onConsume(new ApplyStatusEffectsConsumeEffect(List.of(new MobEffectInstance(MobEffects.HASTE, 6000, 1)), 1.0F))
      .build();
   ...
   public static final Consumable DRY_POT_CHICKEN_C = Consumables.defaultFood()
      .onConsume(new ApplyStatusEffectsConsumeEffect(List.of(new MobEffectInstance(MobEffects.RESISTANCE, 6000, 1)), 1.0F))
      .build();
   ...
   public static final Consumable DRY_POT_SPARE_RIBS_C = Consumables.defaultFood()
      .onConsume(new ApplyStatusEffectsConsumeEffect(List.of(new MobEffectInstance(MobEffects.STRENGTH, 6000, 1)), 1.0F))
      .build();
   ...
   public static final Consumable YANGZHOU_FRIED_RICE_C = Consumables.defaultFood()
      .onConsume(new ApplyStatusEffectsConsumeEffect(List.of(new MobEffectInstance(com.github.ysbbbbbb.kaleidoscopecookery.init.ModEffects.SATIATED_SHIELD, 1600)), 1.0F))
      .build();
   ...
   public static final Consumable YELLOW_CROAKER_TOFU_SOUP_ITEM_C = Consumables.defaultFood()
      .onConsume(new ApplyStatusEffectsConsumeEffect(List.of(new MobEffectInstance(MobEffects.WATER_BREATHING, 9600)), 1.0F))
      .build();
