...
public class FirecrackerBlockEntity extends BlockEntity {
    ...
    public void ignite() {
        if (this.fuse == -1) {
            ...
            if (this.level != null && !this.level.isClientSide) {
                this.level.playSound(null, this.worldPosition, SoundEvents.CREEPER_PRIMED, SoundSource.BLOCKS, 1.0F, 1.0F);
    ...
    protected void saveAdditional(CompoundTag pTag) {
        ...
        pTag.putInt("Fuse", this.fuse);
    }

    public void load(CompoundTag pTag) {
        super.load(pTag);
        this.fuse = pTag.getInt("Fuse");
    }
