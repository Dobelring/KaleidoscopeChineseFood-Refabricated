...
public class FreezingServerRecipe implements ReliableServerRecipe {
    public static final ReliableServerRecipeType<FreezingServerRecipe> TYPE = ReliableServerRecipeType.register(
            Identifier.fromNamespaceAndPath(KaleidoscopeChineseFood.MODID, "freezing"),
            () -> new FreezingServerRecipe(null, null)
    );
    private Ingredient ingredient;
    private ItemStack result;

    public FreezingServerRecipe(@Nullable Ingredient ingredient, @Nullable ItemStack result) {
