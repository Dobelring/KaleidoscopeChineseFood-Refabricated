...
public class Plugins implements IModPlugin {
   ...
   public void registerRecipeCatalysts(@NonNull IRecipeCatalystRegistration registration) {
      ...
      registration.addCraftingStation(FreezingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER));
      registration.addCraftingStation(RefrigeratingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER));
      registration.addCraftingStation(FreezingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_GREEN));
      registration.addCraftingStation(RefrigeratingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_GREEN));
      registration.addCraftingStation(FreezingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_ORANGE));
      registration.addCraftingStation(RefrigeratingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_ORANGE));
      registration.addCraftingStation(FreezingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_PINK));
      registration.addCraftingStation(RefrigeratingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_PINK));
      registration.addCraftingStation(FreezingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_LIGHT_BLUE));
      registration.addCraftingStation(RefrigeratingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_LIGHT_BLUE));
      registration.addCraftingStation(FreezingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_YELLOW));
      registration.addCraftingStation(RefrigeratingRecipeCategory.TYPE, new ItemStack(ModBlocks.FREEZER_YELLOW));
   }
}
