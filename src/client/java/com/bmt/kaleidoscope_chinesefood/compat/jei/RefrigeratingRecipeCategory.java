...
public class RefrigeratingRecipeCategory implements IRecipeCategory<RecipeHolder<RefrigeratingRecipe>> {
   ...
   public void draw(RecipeHolder<RefrigeratingRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
      this.background.draw(guiGraphics);
   }

   public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<RefrigeratingRecipe> holder, IFocusGroup focuses) {
   ...
   public IRecipeHolderType<RefrigeratingRecipe> getRecipeType() {
      return TYPE;
   }
