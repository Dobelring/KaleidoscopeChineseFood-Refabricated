...
public class RefrigeratingRecipeCategory implements IRecipeCategory<RecipeHolder<RefrigeratingRecipe>> {
   ...
   @Override
   public void draw(@NonNull RecipeHolder<RefrigeratingRecipe> recipe, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
