...
public class PicklingJarRecipeCategory implements IRecipeCategory<RecipeHolder<PickleJarRecipe>> {
   ...
   @Override
   public void draw(@NonNull RecipeHolder<PickleJarRecipe> recipe, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
