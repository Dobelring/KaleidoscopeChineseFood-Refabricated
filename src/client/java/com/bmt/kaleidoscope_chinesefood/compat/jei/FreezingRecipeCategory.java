...
public class FreezingRecipeCategory implements IRecipeCategory<RecipeHolder<FreezingRecipe>> {
   ...
   @Override
   public void draw(@NonNull RecipeHolder<FreezingRecipe> recipe, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphics guiGraphics, double mouseX, double mouseY) {
