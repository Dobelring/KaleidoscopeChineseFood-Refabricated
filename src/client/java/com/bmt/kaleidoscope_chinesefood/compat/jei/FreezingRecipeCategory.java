...
public class FreezingRecipeCategory implements IRecipeCategory<RecipeHolder<FreezingRecipe>> {
   ...
   private static final MutableComponent TITLE = Component.translatable("jei.kaleidoscope_chinesefood.freezing");
   ...
   @Override
   public void setRecipe(@NonNull IRecipeLayoutBuilder builder, RecipeHolder<FreezingRecipe> holder, @NonNull IFocusGroup focuses) {
   ...
   @Override
   public void draw(@NonNull RecipeHolder<FreezingRecipe> recipe, @NonNull IRecipeSlotsView recipeSlotsView, @NonNull GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
      this.background.draw(guiGraphics);
   }

   @Override
   public @NotNull IRecipeType<RecipeHolder<FreezingRecipe>> getRecipeType() {
      return TYPE;
   }
